...
def mock_api_dependencies():
    ...
    modules_to_mock = {
        ...
        "stream_pose_ml.actuators.bluetooth_device": bluetooth_device_mock,
    ...
    modules_to_mock["stream_pose_ml"].actuators = modules_to_mock["stream_pose_ml.actuators"]
    modules_to_mock["stream_pose_ml"].blaze_pose = modules_to_mock["stream_pose_ml.blaze_pose"]
    modules_to_mock["stream_pose_ml"].learning = modules_to_mock["stream_pose_ml.learning"]
    modules_to_mock["stream_pose_ml"].transformers = modules_to_mock["stream_pose_ml.transformers"]
