...
class TestProcessVideoJob:
    ...
    def mock_video_data_service(self):
        ...
        with patch('stream_pose_ml.jobs.process_video_job.VideoDataService') as mock_service:
    ...
    def test_process_video_no_keypoint_path(self, mock_video_data_service):
        ...
        # When/Then
        with pytest.raises(ProcessVideoJobError, match="No output location specified for keypoints files."):
    ...
    def test_process_video_no_sequence_path(self, mock_video_data_service):
        ...
        # When/Then
        with pytest.raises(ProcessVideoJobError, match="No output location specified for sequence data files."):
            ProcessVideoJob.process_video(
                input_filename=input_filename,
                video_input_path=video_input_path,
                output_keypoint_data_path="/path/to/keypoints",
