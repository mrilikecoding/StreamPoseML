...
class TestWriteToJsonFile:
    ...
    def test_write_to_json_file_with_dict(self, mock_print, mock_file, mock_dumps, mock_makedirs):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('builtins.print')
    def test_write_to_json_file_with_list(self, mock_print, mock_file, mock_dumps, mock_makedirs):
